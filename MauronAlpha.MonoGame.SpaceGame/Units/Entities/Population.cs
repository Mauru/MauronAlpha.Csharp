...
namespace MauronAlpha.MonoGame.SpaceGame.Units {
	...
	public class Being : GameObject, I_Being, I_RelationTarget, I_RelationSource, I_Moveable {

		public override GameName Name { get {
			return new GameName(Species.Name + "." + Id);
		} }
		...
		public MoveData Move(I_Habitable place) { 
			return place.MovementDataFor(this.Location);
		}
		...
		public override bool IsResource {
			get { return Species.IsResource; }
		}
		public override bool IsSentient {
			get { return D_species.IsSentient; }
		}

		public override bool IsEquipment {
			get { return D_species.IsEquipment; }
		}
	...
	public class Vessel : Being, I_Habitable, I_ComplexBeing {
		...
		public MoveData MovementDataFor(GameLocation location) {
			return new MoveData(this, location);
		}
	}
