	...
	public class FontInfo {
		...
		public String Padding {
			...
			set {
				...
				_Padding=new Rectangle2d(Convert.ToInt32(padding[0]), Convert.ToInt32(padding[1]), Convert.ToInt32(padding[2]), Convert.ToInt32(padding[3]));
			}
		}
		...
		public String Spacing {
			...
			set {
				...
				_Spacing=new Vector2d(Convert.ToInt32(spacing[0]),								Convert.ToInt32(spacing[1]));
			}
		}
